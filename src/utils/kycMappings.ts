...
export const kycMappings: KycTypeMapping = {
  light: {
    ...
    business: [
      ...
      { name: 'tax_id', label: 'Tax ID (government id number)', type: 'text', required: true },
      { name: 'date_of_formation', label: 'Formation Date', type: 'date', required: true },
      { name: 'email', label: 'Email', type: 'email', required: true },
    ],
  },
  standard: {
    individual: [
      ...
      { name: 'id_document_front', label: 'ID Document Front', type: 'file', required: true },
    ],
    business: [],
  },
  enhanced: {
    individual: [
      ...
      { name: 'source_of_funds_document_file', label: 'Source of Funds Document File', type: 'file', required: true },
      { name: 'individual_holding_document_front_file', label: 'Individual Holding Document Front File', type: 'file', required: true },
      {
        ...
        options: [
          ...
          { value: 'payments_to_friends_or_family_abroad', label: 'Payments to Friends/Family Abroad' },
          { value: 'personal_or_living_expenses', label: 'Personal or Living Expenses' },
        ],
      },
      { name: 'purpose_of_transactions_explanation', label: 'Purpose of Transactions Explanation', type: 'text', required: true },
    ],
    business: [],
  },
};
...
export const payoutLimits: Record<string, PayoutLimits> = {
