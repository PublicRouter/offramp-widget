...
export const accountFieldsMapping: Record<string, AccountField[]> = {
  ...
  wire: [
    ...
    { name: 'state_province_region', label: 'State/Province/Region', required: true },
  ...
  spei_bitso: [
    ...
    { name: 'spei_institution_code', label: 'SPEI Institution Code', required: true },
    { name: 'spei_clabe', label: 'SPEI CLABE', required: true },
  ],
  ach_cop_bitso: [
    { name: 'name', label: 'Bank Account Name', required: true },
    { name: 'account_type', label: 'Account Type', required: true },
    { name: 'ach_cop_beneficiary_first_name', label: 'First Name', required: true },
    { name: 'ach_cop_beneficiary_last_name', label: 'Last Name', required: true },
